...
<html>
	...
	<head>
		...
		<script>
			window._deel = {
				name: '静觅',
				url: 'http://cuiqingcai.com/wp-content/themes/Yusi',
				ajaxpager: 'on',
				commenton: 0,
				roll: [0, 0]
			}
		...
		<meta name="keywords" content="个人日记,个人展示,个人随笔" />
		<link rel='next' href='http://cuiqingcai.com/category/life/page/2' />
		...
		<script type="text/javascript">
			window._wpemojiSettings = {
				...
				"svgExt": ".svg",
				"source": {
					"concatemoji": "http:\/\/cuiqingcai.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.7.3"
				}
			};
			! function(a, b, c) {
				function d(a) {
		...
		<script type='text/javascript'>
			...
			var CrayonSyntaxSettings = {
				"version": "_2.7.2_beta",
				"is_admin": "0",
				"ajaxurl": "http:\/\/cuiqingcai.com\/wp-admin\/admin-ajax.php",
				"prefix": "crayon-",
		...
		<!--[if lt IE 9]><script src="http://cuiqingcai.com/wp-content/themes/Yusi/js/html5.js"></script><![endif]-->
	...
	<body class="archive category category-life category-3">
		...
		<header id="header" class="header">
			...
			<div id="nav-header" class="navbar">
				...
				<ul class="nav">
					<li id="menu-item-44" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-44"><a href="">首页</a></li>
					<li id="menu-item-14" class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-has-children menu-item-14"><a href="#">生活笔记</a>
						<ul class="sub-menu">
					...
					<li id="menu-item-7" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-7"><a href="http://cuiqingcai.com/category/technique">技术杂谈</a>
						<ul class="sub-menu">
					...
					<li style="float:right;">
						...
						<div class="search-expand" style="display: none;">
							<div class="search-expand-inner">
								<form method="get" class="searchform themeform" onsubmit="location.href='http://cuiqingcai.com/?s=' + encodeURIComponent(this.s.value).replace(/%20/g, '+'); return false;" action="/">
		...
		<section class="container">
			...
			<div class="banner banner-site"></div>
			<div class="content-wrap">
				<div class="content">
					<header class="archive-header">
						<h1><i class="fa fa-folder-open"></i>  &nbsp;分类：生活笔记  <a title="订阅生活笔记" target="_blank" href="http://cuiqingcai.com/category/life/feed"><i class="rss fa fa-rss"></i></a></h1>
					</header>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/daily">个人日记<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/3998.html" title="回首我的二零一六">回首我的二零一六  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/3998.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://cuiqingcai.com/wp-content/themes/Yusi/img/pic/5.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="回首我的二零一六" /></a>
						</div>
						<span class="note">  没有选择那个二零一六年尾，而是选择了这个二零一六年尾来总结。
 毕竟元旦那时候真的被一堆考试烦透，说到考试，可以说我是极其反对这种形式，在我看来，因为有了考试，学一门课反倒成了任务，而不是真正踏实地去学，有了考试，学习的目的不再是单纯学习，而是为了最后的应考。所以很多科目，经验...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 9个月前 (01-26)</span> <span class="muted"><i class="fa fa-eye"></i> 4742浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/3998.html#comments">22评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="3998" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">113</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/presatation">个人展示<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/3053.html" title="才哥上线——人物摄影记录起始篇">才哥上线——人物摄影记录起始篇  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/3053.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://wonderlee.me/wp-content/uploads/2016/08/2016-08-2132-1-1024x575.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="才哥上线——人物摄影记录起始篇" /></a>
						</div>
						<span class="note"> 声明
转载自某摄影小能手：http://wonderlee.me/2500.html
不得不说，读起来简直太赞，啧，哎呀，难以语言形容啊，赶紧往下看去体会！
话说其实小能手的单反技能都是我教的啊哈哈哈（仰天长笑五分钟）……在我的耐心教导下，已经成长为摄影小能手啦！哈哈！
原文

...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 1年前 (2016-08-31)</span> <span class="muted"><i class="fa fa-eye"></i> 6096浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/3053.html#comments">16评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="3053" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">55</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/notes">个人随笔<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/2416.html" title="弃用多说，改用畅言">弃用多说，改用畅言  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/2416.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2016/02/bg1-e1454442892955.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="弃用多说，改用畅言" /></a>
						</div>
						<span class="note"> 最近博客的多说评论总是抽风，先来吐槽一下。
刚在整理评论的时候吓我一跳，之前我的好多评论都没了，是的，是只有我自己的评论没有了，而其它人的评论还有。摸不着头脑的我打开多说后台管理，哦天，我之前所有的评论和回复全部自动转为垃圾评论了，八百多条啊，废了一会功夫好不容易批量还原了。结果...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 2年前 (2016-02-02)</span> <span class="muted"><i class="fa fa-eye"></i> 12167浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/2416.html#comments">84评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="2416" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">99</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/daily">个人日记<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/2401.html" title="强势回归博客，顺便祝大家小年快乐">强势回归博客，顺便祝大家小年快乐  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/2401.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2016/02/2.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="强势回归博客，顺便祝大家小年快乐" /></a>
						</div>
						<span class="note"> Hello，时隔一个多月，终于再次回到博客啦，首先跟大家说声抱歉，许多评论没有及时回复感到非常抱歉，希望我现在给大家的回复为时不晚。
距离上次在博客上写日记过去了几个月了吧。那时的我刚刚结束大学三年级。而现在，大四上半学期已经过半啦。这半年的时间可以说忙也可以说不忙。不忙是说这半...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 2年前 (2016-02-01)</span> <span class="muted"><i class="fa fa-eye"></i> 3673浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/2401.html#comments">14评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="2401" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">29</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/daily">个人日记<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1883.html" title="假期到啦，重新回归代码之路">假期到啦，重新回归代码之路  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1883.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/07/wallpaper_5227194.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="假期到啦，重新回归代码之路" /></a>
						</div>
						<span class="note"> 二零一五年七月九日，伴随着最后一门图形学交卷铃声的想起，我的大三正式结束了。首先很抱歉，最近一段时间一直在忙考试复习，时间也比较紧张，另外就是整理各种材料，还有准备一些面试，也算是忙得不亦乐乎，所以，这段时间也没有去编代码，大约也有一个月的时间没有更新博客了，有好多热心的朋友在我...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 2年前 (2015-07-12)</span> <span class="muted"><i class="fa fa-eye"></i> 4766浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1883.html#comments">14评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1883" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">37</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/daily">个人日记<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1722.html" title="记一次泰安方特之旅">记一次泰安方特之旅  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1722.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/05/wallpaper_5265747.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="记一次泰安方特之旅" /></a>
						</div>
						<span class="note"> 等啊等，终于等到五一放假，这次必须要出去好好玩一番，解脱一下，释放一下。经过一系列思想斗争，最终决定去泰安方特了！昨天方特之旅结束之后，甚是爽快，在此记流水账一篇，不喜勿喷哈！
话说回来还是要先说五月二号啊，简直了，本来打算是在五月二号去的，带上室友小周周和隔壁的花花学长。一号那...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 3年前 (2015-05-04)</span> <span class="muted"><i class="fa fa-eye"></i> 3043浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1722.html#respond">0评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1722" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">24</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/notes">个人随笔<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1547.html" title="致那逝去的三月">致那逝去的三月  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1547.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/04/1-e1428092392689.png&h=123&w=200&q=90&zc=1&ct=1" alt="致那逝去的三月" /></a>
						</div>
						<span class="note"> 4月4日，凌晨3点，我依旧无法入眠，心里想了很多，索性起床把现在的所想记录下来。也许，在一觉过后，这些情感或许就无法挥洒出来了。现在，借着那纯音乐，借着那静谧的夜，总结一下那逝去的三月。
三月一日开学，到现在已经有了一个月多一点的时间了，都说大三下是最难熬的一段时光，亲身经历之后...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 3年前 (2015-04-03)</span> <span class="muted"><i class="fa fa-eye"></i> 4273浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1547.html#comments">9评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1547" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">60</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/notes">个人随笔<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1458.html" title="开始备战了">开始备战了  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1458.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/03/wallpaper_5224934-e1426517127365.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="开始备战了" /></a>
						</div>
						<span class="note"> 博主来自山东大学，现在大三了，想保研北京航空航天大学。去年的保研政策，其中复试是这么规定的
北京航空航天大学计算机学院
1、学院复试工作小组对申请者各项材料（含体格检查表及推免服务系统填写的网上报名志愿）进行综合评审，确定复试名单，通过“推免服务系统”发放复试通知。接到“推免服务...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 3年前 (2015-03-16)</span> <span class="muted"><i class="fa fa-eye"></i> 2737浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1458.html#respond">0评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1458" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">18</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/notes">个人随笔<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1250.html" title="珍惜自己年轻的时光吧">珍惜自己年轻的时光吧  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1250.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/03/wallpaper_5254642.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="珍惜自己年轻的时光吧" /></a>
						</div>
						<span class="note"> 话说书桌比较乱的人比较有创造力？很不幸我的桌面我好像就是这么一个人呐，哈哈哈我开玩笑的~
一直以来养成了一个定期清理书桌的习惯，在不到那个清理的时间，我会随意摆放自己想要摆放的东西，有时候，我的桌面比较乱也是正常的。这不，今天周六了嘛，整理一下东西吧。三下五除二，桌面回归了它正常...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 3年前 (2015-03-07)</span> <span class="muted"><i class="fa fa-eye"></i> 3198浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1250.html#comments">6评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1250" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">14</span>喜欢</a></span>
						</p>
					</article>
					<article class="excerpt">
						<header><a class="label label-important" href="http://cuiqingcai.com/category/life/daily">个人日记<i class="label-arrow"></i></a>
							<h2><a target="_blank" href="http://cuiqingcai.com/1216.html" title="收到的赞助">收到的赞助  </a></h2>
						</header>
						<div class="focus">
							<a target="_blank" href="http://cuiqingcai.com/1216.html"><img class="thumb" src="http://cuiqingcai.com/wp-content/themes/Yusi/timthumb.php?src=http://qiniu.cuiqingcai.com/wp-content/uploads/2015/03/wallpaper_5264966.jpg&h=123&w=200&q=90&zc=1&ct=1" alt="收到的赞助" /></a>
						</div>
						<span class="note"> 2015/3/2
支付宝转账 &#8211; 郭先生 &#8211; 10元
2015/3/14
微信支付 &#8211; 高先生 &#8211; 5元
2015/3/21
...
微信支付 &#8211; 邵...</span>
						<p class="auth-span">
							<span class="muted"><i class="fa fa-user"></i> <a href="http://cuiqingcai.com/author/cqcre">崔庆才</a></span>
							<span class="muted"><i class="fa fa-clock-o"></i> 3年前 (2015-03-02)</span> <span class="muted"><i class="fa fa-eye"></i> 5017浏览</span> <span class="muted"><i class="fa fa-comments-o"></i> <a target="_blank" href="http://cuiqingcai.com/1216.html#comments">2评论</a></span>
							<span
								class="muted">
								<a href="javascript:;" data-action="ding" data-id="1216" id="Addlike" class="action"><i class="fa fa-heart-o"></i><span class="count">21</span>喜欢</a></span>
						</p>
					</article>
					<div class="pagination">
						<ul>
							...
							<li><a href='http://cuiqingcai.com/category/life/page/2'>2</a></li>
							<li class="next-page"><a href="http://cuiqingcai.com/category/life/page/2">下一页</a></li>
						</ul>
					</div>
				</div>
			</div>
			<aside class="sidebar">
				<div class="widget widget_text">
					<div class="textwidget">
						<div class="social">
							...
							<a href="http://weibo.com/u/2830678474" rel="external nofollow" title="新浪微博" target="_blank"><i class="sinaweibo fa fa-weibo"></i></a><a href="http://t.qq.com/CQCcqc123456?preview" rel="external nofollow" title="腾讯微博" target="_blank"><i class="tencentweibo fa fa-tencent-weibo"></i></a>
							<a
								class="weixin"><i class="weixins fa fa-weixin"></i>
								<div class="weixin-popover">
									<div class="popover bottom in">
										<div class="arrow"></div>
										<div class="popover-title"></div>
										<div class="popover-content"><img src="http://cuiqingcai.com/wp-content/themes/Yusi/img/weixin.gif"></div>
									</div>
								</div>
								</a>
								<a href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=cqc@cuiqingcai.com" rel="external nofollow" title="Email" target="_blank"><i class="email fa fa-envelope-o"></i></a>
				...
				<div class="widget widget_text">
					<div class="title">
						<h2>职位推荐</h2></div>
					<div class="textwidget">
						<div class="p-sm" style="padding-bottom:15px">
							<ul>
								<li>
    ...
    font-size: 13px;" class="btn btn-xs btn-danger" target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=31ed8a7d15339353ad090379bb9243118f90220324a7a0f4b453bce52dcd02b6">立即加入</a>
				...
				<div class="widget widget_text">
					<div class="title">
						<h2>微信公众号</h2></div>
					<div class="textwidget">
						<div class="p-sm" style="overflow:hidden;padding-bottom:12px">
							<p class="text-center">
								学习累了吧，扫个码玩玩吧~
							</p>
							<div class="text-center" style="float:left">
    ...
    font-size: 12px;" class="btn btn-xs btn-danger" target="_blank">进击的Coder</a>
				...
				<div class="widget d_tag">
					<div class="title">
						<h2>标签云</h2></div>
					<div class="d_tags"><a title="43个话题" href="http://cuiqingcai.com/tag/python">Python (43)</a><a title="38个话题" href="http://cuiqingcai.com/tag/%e7%88%ac%e8%99%ab">爬虫 (38)</a><a title="31个话题" href="http://cuiqingcai.com/tag/php">PHP (31)</a><a title="21个话题" href="http://cuiqingcai.com/tag/js">JS (21)</a>
						<a
							title="12个话题" href="http://cuiqingcai.com/tag/html">HTML (12)</a><a title="11个话题" href="http://cuiqingcai.com/tag/opengl">OpenGL (11)</a><a title="9个话题" href="http://cuiqingcai.com/tag/jquery">jQuery (9)</a><a title="7个话题" href="http://cuiqingcai.com/tag/linux">Linux (7)</a><a title="7个话题" href="http://cuiqingcai.com/tag/wordpress">WordPress (7)</a>
							<a
								title="7个话题" href="http://cuiqingcai.com/tag/winpcap">Winpcap (7)</a><a title="6个话题" href="http://cuiqingcai.com/tag/css">CSS (6)</a><a title="6个话题" href="http://cuiqingcai.com/tag/security">Security (6)</a><a title="4个话题" href="http://cuiqingcai.com/tag/git">Git (4)</a><a title="4个话题" href="http://cuiqingcai.com/tag/bootstrap">Bootstrap (4)</a>
								<a
									title="4个话题" href="http://cuiqingcai.com/tag/net">Net (4)</a><a title="3个话题" href="http://cuiqingcai.com/tag/java">Java (3)</a><a title="3个话题" href="http://cuiqingcai.com/tag/mysql">Mysql (3)</a><a title="2个话题" href="http://cuiqingcai.com/tag/cocos2d-x">Cocos2d-x (2)</a><a title="2个话题" href="http://cuiqingcai.com/tag/jsp">JSP (2)</a>
									<a
										title="2个话题" href="http://cuiqingcai.com/tag/matlab">Matlab (2)</a><a title="2个话题" href="http://cuiqingcai.com/tag/photoshop">Photoshop (2)</a><a title="2个话题" href="http://cuiqingcai.com/tag/less">LESS (2)</a><a title="2个话题" href="http://cuiqingcai.com/tag/sass">SASS (2)</a><a title="1个话题" href="http://cuiqingcai.com/tag/json">Json (1)</a>
										<a
											title="1个话题" href="http://cuiqingcai.com/tag/redis">Redis (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/nginx">Nginx (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/appium">Appium (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/gulp">Gulp (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/laravel">Laravel (1)</a>
											<a
												title="1个话题" href="http://cuiqingcai.com/tag/%e6%b5%8b%e8%af%95">测试 (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/app">APP (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/ssh">SSH (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/scrapy%e5%88%86%e5%b8%83%e5%bc%8f">Scrapy分布式 (1)</a>
												<a
													title="1个话题" href="http://cuiqingcai.com/tag/%e8%a7%86%e9%a2%91">视频 (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/python3">Python3 (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/scrapy">Scrapy (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/%e7%9f%a5%e4%b9%8e">知乎 (1)</a><a title="1个话题"
														href="http://cuiqingcai.com/tag/neo4j">Neo4j (1)</a><a title="1个话题" href="http://cuiqingcai.com/tag/http">HTTP (1)</a></div>
				</div>
				...
				<div class="copyright pull-left">
					...
					<div>
						<script type="text/javascript">
							...
							document.write(unescape("%3Cspan id='cnzz_stat_icon_1253486800'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1253486800%26online%3D1%26show%3Dline' type='text/javascript'%3E%3C/script%3E"));
						</script>
					</div>
				</div>
...
<!-- Cached page generated by WP-Super-Cache on 2017-10-25 08:44:18 -->
